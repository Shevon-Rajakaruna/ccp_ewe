...
<div class="content-body">
	...
	<div class="col-md-12">
		<div class="card card-info">
			...
			<div class="card-body">
			<form role="form" method="post" action="{{ route('department.update',$dep->id) }}">
				@csrf
				<div class="row">
				    <div class="col-sm-6">
				      	<div class="form-group">
				  	       	<label>Department Name: </label>
				    		<input type="text" name="desp" class="form-control" value="{{$dep->desp}}">
						</div>
				    </div>
				    ...
				    <div class="col-sm-6">
				    	<div class="form-group">
						  	...
						  	<select name="faculty" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
							    <option data-select2-id="3">{{$dep->faculty}}</option>
