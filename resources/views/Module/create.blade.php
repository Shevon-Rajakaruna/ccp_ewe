          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="mod_code" class="form-control" placeholder="Module Code Here">
              </div>
            </div>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="mod_name" class="form-control" placeholder="Module Name Here">
              </div>
            </div>
          ...
          <div class="row">     
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input type="text" name="lec_hours" class="form-control" placeholder="Enter Lecture Hours...">
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input type="text" name="tute_hours" class="form-control" placeholder="Enter Tutorial Hours...">
              </div>
            </div>
             ...
             <div class="col-sm-3">
              <div class="form-group">
                ...
                <input type="text" name="lab_hours" class="form-control" placeholder="Enter Laboratory Hours...">
              </div>
            </div>
