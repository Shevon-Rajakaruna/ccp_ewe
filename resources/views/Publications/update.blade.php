	...
	<div class="col-md-12">
		<div class="card card-info">
			<div class="card-header" style="background-color: #66bb6a !important;">
				<h3 class="card-title">Edit Publication Details</h3>
			</div>
			<div class="card-body">
			<form role="form" method="post" action="{{ route('publication.update',$model->id) }}">
				@csrf
	            ...
	            <textarea class="form-control" rows="3" name="pub_description">{{$model->pub_description}}</textarea>
						</div>			     
			    </div>    
				</div>
			  ...
			  <div class="row">
			  	<div class="col-sm-6">
			    	<label>Published Date</label>
						<input type="date" class="form-control" name="pub_date" value="{{$model->pub_date}}" data-inputmask-alias="datetime" data-inputmask-inputformat="mm/dd/yyyy" data-mask>
			    </div>
			  </div>
