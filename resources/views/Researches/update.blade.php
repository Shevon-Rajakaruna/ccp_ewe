	...
	<div class="col-md-12">
		<div class="card card-info">
			<div class="card-header" style="background-color: #ffb342 !important;">
				<h3 class="card-title">Edit Research Details</h3>
			</div>
			<div class="card-body">
			<form role="form" method="post" action="{{ route('research.update',$model->id) }}">
				@csrf
        ...
        @endif
            ...
            <input type="date" class="form-control" name="start_date" value="{{ $model->start_date }}" data-inputmask-alias="datetime" data-inputmask-inputformat="mm/dd/yyyy" data-mask>
					</div>
					<div class="col-sm-6">
            <label>Group ID</label>
            <input type="text" name="groupID" class="form-control" value="{{ $model->groupID }}">
          </div>
				</div>
            ...
            <input type="date" class="form-control" name="complete_date" value="{{ $model->complete_date }}" data-inputmask-alias="datetime" data-inputmask-inputformat="mm/dd/yyyy" data-mask>
					</div>
					<div class="col-sm-6">
