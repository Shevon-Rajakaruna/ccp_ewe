...
<div class="container-fluid">
    <div class="card card-info">
		<div class="card-header">
			<h3 style="font-size:20px" class="card-title">Update Educational Qualifications</h3>
		</div>
		<div class="card-body">
		<form role="form" method="post" action="{{ route('educational.update',$education->id) }}">
			@csrf
			...
			<div class="row">
			    <div class="col-sm-12">
			    	<div class="form-group">
        				...
        				<input class="form-control form-control-sm" type="text" name="field" value="{{$education->field}}">
					</div>			     
			    </div>    
			</div>
	          ...
	          <div class="col-md-6">
	            <div class="form-group">
	              ...
	              <select class="form-control select2" name="start_date" style="width: 100%;">
	                <option selected="selected">{{$education->start_date}}</option>
	                <option>1999</option>
	                <option>2000</option>
	                <option>2001</option>
	                <option>2002</option>
	          ...
	          <div class="col-md-6">
	            <div class="form-group">
	              ...
	              <select class="form-control select2" name="end_date" style="width: 100%;">
	                <option selected="selected">{{$education->end_date}}</option>
	                <option>2030</option>
	                <option>2029</option>
	                <option>2028</option>
	                <option>2027</option>
